  ...
  const handleVerification = async e => {
    ...
    try {
      ...
      if (result.success && result.isPaid) {
        ...
        try {
          await axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('http://localhost:4000/presences', {
            type: 'adherent',
            nom,
            prenom,
          ...
          console.error("Erreur d'enregistrement de présence:", err);
          // On continue la redirection même si l'enregistrement échoue
          setTimeout(() => {
            navigate('/confirmation');
          }, 100);
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4c378fbefe713d7a8ac1")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.ac290e10dda8e4153eaf.hot-update.js.map